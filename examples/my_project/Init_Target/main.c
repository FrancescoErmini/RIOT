...
int pn532_initialization(pn532_t * pn532){
		 printf("trying to retrieve PN532 information...");
		    ...
		    pn532_begin(pn532);
		    	...
		    	printf("Found Chip: PN5%02X, firmware version: %02X.%02X",ic,version,rev);
return 1;
}
...
int main(void)
{
		...
		delay(5);
		uint8_t out1[] = { 0x01, 0x02, 0x03, 0x04, 0x05 };
		uint8_t out2[] = { 0x11, 0x12, 0x13, 0x14, 0x15 };
		uint8_t resp1[] ={0x00,0x00,0x00,0x00,0x00 };//up to 255
